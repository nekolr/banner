...
function FragmentBanner(option) {
	...
	//实例化时，可传的参数
	this.whiteList = ['container','controller','size','imgs','size','grid','index','fnTime','boxTime','type','links','titles','intros'];
...
FragmentBanner.prototype = {
	...
	setIndex : function(){
		...
		this.elem.numFind[this.index].className = 'on'; 
		// link，如果要加链接可以放开
		// this.elem.numFind[this.index].parentNode.parentNode.children[0].href = this.links[this.index];
		// if(this.index == 7){
		// 	this.elem.numFind[this.index].parentNode.parentNode.children[0].target = "_self";
		// }
		// else{
		// 	this.elem.numFind[this.index].parentNode.parentNode.children[0].target = "_blank";
		// }

		// this.elem.numFind[this.index].parentNode.parentNode.children[4].children[0].innerHTML = this.titles[this.index];
		// this.elem.numFind[this.index].parentNode.parentNode.children[4].children[1].innerHTML = this.intros[this.index];
		// if(this.index == 0){
		// 	this.elem.text.style.display = "none";
		// }
		// else{
		// 	this.elem.text.style.display = "block";
		// }
